const MissionVission = () => {
  return (
    <div className="flex flex-col xl:flex-row gap-[60px] xl:gap-[130px]">
      {/* mission */}
      <div>
        <h3 className=" text-center xl:text-left text-2xl xl:text-[36px] text-textGray xl:leading-[44px] mb-[15px] font-bold">
          Our Mission
        </h3>
      ...
      {/* vission */}
      <div>
        <h3 className="text-center xl:text-left text-2xl xl:text-[36px] text-textGray leading-[44px] mb-[15px] font-bold">
          Our Vision
        </h3>
        <p className="text-center xl:text-left text-sm xl:text-lg xl:leading-[30px] text-textGrayV3">
